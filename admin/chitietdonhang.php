                ...
                <div class="activity-grid">
                    <div class="activity-card">
                        ...
                        ?>
                            ...
                            <h2>Orders are waiting for confirmation</h2>
                                    ...
                                    <table class="display">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                <td colspan="6" style="background-color:#2a2b2c;text-align:center;color:white;">Total order: <?php echo number_format($tong0, 0, ',', '.') . "" . "đ"; ?></td>
                                                <td colspan="4" style="background-color:#2a2b2c;">
                                                    <div>
                                                        
                                                        <a class="ti-check" style="font-size:15px;" onclick="return confirm('Bạn có chắc chắn muốn xác nhận đơn hàng này')" href="?order=<?php echo $orderID ?>&status=1&userId=<?php echo $userId; ?>&action=0&username=<?php echo $username; ?>"> Order confirmation</a>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="color:blue;cursor:pointer">Being transported</td>
                                                                </tr>
                                                            <?php

                                                            }
                                                            ?>
                                                            <td colspan="11" style="background-color:#2a2b2c;text-align:center;color:white;">Total order: <?php echo number_format($tong1, 0, ',', '.') . "" . "đ"; ?></td>
                                                <?php
                                                        }
                                                    }
                                                }
                                                    ...
                                                    <table>
                                                        <thead>
                                                            <tr>
                                                                <th>Order: <?php echo $count; ?></th>
                                                                <th colspan="2">Account: <?php echo $username; ?></th>
                                                                <th colspan="2">Order time: <?php echo $result_date['order_time']; ?></th>
                                                                <th colspan="3">Recieve time: <?php echo $result_date['recieve_time']; ?></th>
                                                                <th colspan="2" class="toggle">Details</th>
                                                            </tr>
                                                        </thead>
                                                    </table>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                    <tr>
                                                                        ...
                                                                        <td style="color:blue;cursor:pointer">Recieved</td>
                                                                    </tr>
                                                                <?php

                                                                }
                                                                ?>
                                                                <td colspan="11" style="background-color:#2a2b2c;text-align:center;color:white;">Total orders: <?php echo number_format($tong2, 0, ',', '.') . "" . "đ"; ?></td>
                                                        <?php
                                                                //}
                                                            }
                                                        }
                                                            ...
                                                            <table>
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th colspan="3">Recieve date: <?php echo $result_date['recieve_time']; ?></th>
                                                                        <th colspan="2" class="toggle">Details</th>
                                                                    </tr>
                                                                </thead>
                                                            </table>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                            <tr>
                                                                                ...
                                                                                <td style="color:red;cursor:pointer">Request return</td>
                                                                            </tr>
                                                                        <?php

                                                                        }
                                                                        ?>
                                                                        <td colspan="6" style="background-color:#2a2b2c;text-align:center;color:white;">Total orders: <?php echo number_format($tong2, 0, ',', '.') . "" . "đ"; ?></td>
                                                                        <td colspan="5" style="background-color:#2a2b2c;text-align:center;color:white;cursor:pointer;">
                                                                            <a style="text-decoration:none;font-size:15px;"
                                                                             onclick="return confirm('You want to confirm the return?')" 
                                                                             href="?orderID=<?php 
                                                                             echo $orderID ?>&status=3&userId=<?php echo $userId; ?>&action=3&username=<?php echo $username; ?>" class="ti-check"> Accept requests</a>
                                                                        </td>
                    </div>
                ...
                <table class="display">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            ?>
                            <td colspan="11" style="background-color:#2a2b2c;text-align:center;color:white;">Total order: <?php echo number_format($tong2, 0, ',', '.') . "" . "đ"; ?></td>
                <?php
                        }
                    }
                }
