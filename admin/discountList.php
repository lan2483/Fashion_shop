                    ...
                    <div class="activity-card">
                        <div class="activity-header">
                            ...
                            <div class="activity-more">
                                ...
                                <a href="discountadd.php">Add coupon codes</a>
                            </div>
                        </div>
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th>Coupon code</th>
                                        <th>Number of coupon codes</th>
                                        <th>Coupon code conditions</th>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <?php 
                                                 ...
                                                 ?>
                                                    <td>Decrease with percentage</td>
                                                <?php   
                                                    } else {
                                                ?>
                                                    <td>Decrease according to money</td>
                                                <?php
                                                    }
                                                ?>
                                                <?php 
                                                ...
                                                ?>
                                                <td>
                                                    <a onclick="return confirm('You are sure to delete')" href="?delcoupon_id=<?php echo $result['coupon_id'] ?>">Delete</a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
