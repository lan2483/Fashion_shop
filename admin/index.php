                            ...
                            <form method="POST" action="">
                                <div class="activity-card-calendar">
                                        ...
                                        <div class="input-group mb-3">
                                            <input id="datePickerId" value="2023-12-28" name="date1" type="date" data-date-inline-picker="true" />
                                        </div>
                                        <div class="input-group mb-3">
                                            <input id="datePickerId" value="2023-01-10" name="date2" type="date" data-date-inline-picker="true" />
                                        </div>
                                        <div class="input-group1 mb-3">
                                            <input id="submit" name="submit" type="submit" value="Find">
                                        </div>
                                ...
                                <div class="table-responsive">
                                    <table>
                                        ...
                                        ?>
                                                ...
                                                <td></td>
                                                <td>
                                                    Number of products sold : <?php echo $totalquantity ?>
                                                </td>
                                                <td>
                                                    Total money for sale: <?php echo number_format($sumDT, 0, ',', '.') . " " . "đ"; ?>
                                                </td>
                                                </tbody>
                                            <?php
                                        } else {
                                            ?>
                                                <tbody>
                                                    <tr>
                                                        <td colspan="4" style="text-align:center">There is no product in this timeline</td>
                                                    </tr>
                                                </tbody>
                                            <?php
                                        }
