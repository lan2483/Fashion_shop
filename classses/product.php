...
class product
{
    ...
    public function insert_product($data, $files)
    {
        ...
        if ($productName == "" ||  $brand == "" || $typeProduct == "" ||  $category == "" ||  $product_desc == "" ||  $price == "" ||  $type == "" ||  $file_name == "" || $quantity == "") {
            ...
            return "The price is not negative";
        }else{
            ...
            if($result_check_name){
                return "Product name has existed";
            }else{
                ...
                if ($result) {
                    ...
                    $alert = "<span class='error'> Add unsuccessfull  </span>";
                    return $alert;
                }
            }
        }
    ...
    public function update_product($data, $files, $id)
    {
        ...
        if (!empty($file_name)) {
            ...
            if ($file_size > 20480) {
                $alert = "<span class='error'> Can only download photos below 20MB </span>";
                return $alert;
