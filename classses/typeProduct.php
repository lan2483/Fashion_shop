    ...
    class typeProduct 
    {
        ...
        public function insert_type_product($data)
        {
            ...
            if ($typeProductName==""||  $catID=="") {
                ...
                if ($result) {
                    $alert = "<span class='success'> Add successful   </span>";
                    return $alert;
                } else {
        ...
        public function update_type_product($data,$id){
            ...
            if(empty($typeProductName) || empty($catID) ) {
                $alert = "<span class='success'>No empty</span>  ";
                return $alert;
            } else {
                ...
                if($result) {
                    $alert = "
                      <span class='success'>Successful editing</span>  
                    ";
                    return $alert;
                } else {
                    $alert = "
                      <span class='error'>Unsuccessful</span>  
                    ";
                    return $alert;
                }
            }
