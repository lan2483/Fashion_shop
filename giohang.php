							...
							<div class="col l-12">
								<div class="checkout-process-bar block-border">
									<ul>
										...
										<li class=""><span>Pay</span></li>
										<li><span>Complete the order</span></li>
									</ul>
								</div>
							</div>
							<div class="col l-12">
								<h1 style="margin: 20px;font-weight: 600;font-size: 24px;line-height: 32px;color: #221f20;font-family: var(--font-family-sans-serif);">Your cart </h1>
							</div>
									...
									<tbody>
										...
										?>
												<tr>
													...
													<td>
														<a onclick="return confirm('You are sure to delete')" href="?cartID=<?php echo $result_ProductCat['cartID'] ?>" class="ti-close"><?php ?></a>
													</td>
												</tr>
										<?php
												$dem++;
							...
							<div class="cart-voucher">
								...
								?>
									...
									<div class="cart-purchase">
										<span class="sum-product">Into money</span>
									...
									<div class="cart-purchase-button">
										<a href="thanhtoan.php"><button>Purchase</button></a>
									</div>
								<?php
								} else {
