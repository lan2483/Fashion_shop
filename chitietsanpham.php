...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    if (Session::get('user_login') == false) {
        ...
        if ($_POST['size'] == "") {
            ...
            echo 'alert("You have not chosen size")';
            echo '</script>';
        } else if ($checkQuantity == false) {
            echo '<script type ="text/JavaScript">';
            echo 'alert("The product is out of stock, hope you come back later !")';
            echo '</script>';
        } else {
            $size = $_POST['size'];
...
if (isset($_POST['comments']) && $_POST['content'] != "" && $_POST['date_comment'] != "") {
    if (Session::get('user_login') == false) {
        $tb = '<span class="fix_bug">Request login !</span>';
    } else {
        $binhluan = $user->insert_comments();
    }
} elseif (isset($_POST['comments']) && $_POST['content'] == "") {
    $tb = '<span class="fix_bug">You have not entered the comment ?</span>';
}
...
if (isset($_POST['rep_submit']) && $_POST['rep_content'] != "") {
    ...
    $tb = '<span class="fix_bug">You have not entered the response ?</span>';
} elseif (isset($_POST['comments']) && isset($_POST['rep_content']) == ' ') {
    $tb = '<span class="fix_bug">Invalid characters !</span>';
} else {
    echo "";
}
?>
                            ...
                            <div class="col l-6">
                                <div class="home-product-icon">
                                    ...
                                    <div class="home-product-item__sales">
                                        ...
                                        <span class="home-product-item__click ">Evaluate</span>
                                        <span class="home-product-item__bot"></span>
                                    ...
                                    <div class="home-product-item__ship">
                                        <span class="home-product-item__ship-title">Transport</span>
                                        <div class="home-product-item__ship-with">
                                            <p class="home-product-item__ship-content">
                                                <i class="fas fa-truck"></i>
                                                Free shipping
                                            </p>
                                            <p class="home-product-item__ship-canle">Free shipping for orders over 300,000 VND</p>
                                        </div>
                                    </div>
                                    <div class="all-form-controls">
                                        <form action="" method="post">
                                            ...
                                            <input type="hidden" id="btn_sizes" name="size" value="You have not chosen size">
                                                ...
                                                <div class="modal__overlay">
                                                    <div class="model__body">
                                                        <div class="table-size-product" style="display: none" id="table-size-product">
                                                            ...
                                                            <div class="title-table-size">Size consultancy table</div>
                                                            <div class="exclusive-tabs">
                                                                <div class="exclusive-head">
                                                                    <ul>
                                                                        <li class="exclusive-tab " onclick="changeBestSeller('men',this)">Men</li>
                                                                        <li class="exclusive-tab  active " onclick="changeBestSeller('women',this)">Women</li>
                                                                        <li class="exclusive-tab " onclick="changeBestSeller('kids',this)">Children</li>
                                                                    </ul>
                                                                </div>
                                                                            ...
                                                                            <div class="col l-12">
                                                                                <table class="table-pc" style="width: 100%;">
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>8</td>
                                                                                            <td>The length from the crotch to the pants tube</td>
                                                                                            <td>42</td>
                                                                                            <td>52</td>
                                                                                            <td>59</td>
                                                                                            <td>66</td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td colspan="6"><b>* The measurement in "parameter table" is a body measurement not a measurement of clothes</b></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </div>
                                            ...
                                            <div style="padding: 20px 0;color: black;">
                                                ...
                                                ?>
                                                    <span>The number of products (<?php echo $result_Details['quantity'] ?> Product)</span>
                                                    <?php
                                                } else {
                                                ?>
                                                    <span style="color: red ;">The product is out of stock</span>
                                                <?php
                                                }
                                                    ?> 
                                            ...
                                            <div>
                                                ...
                                                if (isset($addToCart)) {
                                                    ...
                                                    echo '<span style="color:red;">The product has existed in the cart, size and quantity updated</span>';
                                                }
                                                ?>
                                            </div>
                                            <div style="text-align: center;padding: 40px;align-items: center; display: flex; justify-content: center;     border-bottom: 1px solid #ccc;">
                                                ...
                                                if (Session::get('user_login') == false) {
                                                ?>
                                                    <input type="button" value="Add product" class="btn--primary" onclick="swal_login_false()"><i class="fas fa-cart-plus" style="margin-left:10px; font-size:48px;"></i></input>
                                                <?php
                                                } else {
                                                ?>
                        ...
                        <form action="" method="post">
                            <div style="display: flex;align-items: center;justify-content: space-between;">
                                ...
                                <section style="width: 90%;">
                                    <input pattern="\S+.*" autocomplete="off" class="comment-tacontent" name="content" placeholder="Comment..."></input>
                                </section>
                            </div>
                            ...
                            <section style="display: flex;align-items: center;justify-content: end;">
                                <input class="comment-ipsubmit" type="submit" name="comments" value="Send">
                            </section>
                            <div>
                                <?php
                                $p = $_GET['productId'];
                    ...
                    ?>
                            ...
                            <form action="" method="post">
                                ...
                                <section style="display: flex;align-items: flex-start;">
                                    <input name="rep_submit" class="ok" type="submit" value="Feedback"></input>
            ...
            ?>
                if (Quantity >= <?= $result_Details['quantity'] ?>) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Oops...',
                        text: 'Has reached the maximum number',
                    })
                } else {
                    Quantity++
                }
