...
if (isset($_POST['doimatkhau']) && $_POST['password_cu']!="" && $_POST['password_moi'] != "") {
    ...
    if ($count > 0) {
        ...
        $up = '<span class="ErrorUpdate_pass">Enter the wrong password, invite to enter again !</span>';
    }
}else{
    $up = '<span class="ErrorUpdate_pass">You have not entered the password ?</span>';
}
?>
                            ...
                            <form action="" method="post">
                                <div class="information">
                                    ...
                                    <div style="display: flex;justify-content: end;" class="infotmation-save">
                                        ...
                                        <input type="submit" name="doimatkhau" value="Enter">
                                    </div>
                            </form>
