                ...
                <div class="row">
                    ...
                    <div class="col m-12 l-9">
                        ...
                        <ul style="display:flex;">
                            <li class="QLdonhang" onclick="changeProductList('choXN',this)">Wait for confirmation</li>
                            <li class="QLdonhang" onclick="changeProductList('daNH',this)">Delinquent</li>
                            <li class="QLdonhang" onclick="changeProductList('daGiao',this)">Delivered</li>
                            <li class="QLdonhang" onclick="changeProductList('traHang',this)">Return</li>
                            <li class="QLdonhang" onclick="changeProductList('daHuy',this)">Canceled</li>
                        </ul>
                        <div class="col l-12">
                                    ...
                                    <table id="choXN" class="choXN table_0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th colspan="5">Order time: <?php echo $result_date['order_time']; ?></th>
                                                <th colspan="2" class="toggle">Details</th>
                                            </tr>
                                        </thead>
                                        <!-- </table> -->
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td style="color:red;cursor:pointer">Waiting for confirmation</td>
                                                    ...
                                                    ?>
                                                    <td colspan="7" style="background-color:#2a2b2c;text-align:center;color:white;">Total order: <?php echo number_format($total0, 0, ',', '.') . "" . "đ"; ?></td>
                                                    <td colspan="3" class="huy_don" style="background-color:#2a2b2c;">
                                                        <div style="display: flex;align-items: center;justify-content: space-evenly;">
                                                            ...
                                                            <a style="text-decoration:none;font-size:20px;" onclick="return confirm('Are you sure you want to cancel this order')" href="?orderID=<?php echo $orderID ?>">Cancellate</a>
                                                        </div>
                                                    </td>
                                            <?php
                                                }
                                ...
                                ?>
                                        <table id="daNH" class="daNH table_1">
                                            <thead>
                                                <tr>
                                                    <th>Order: <?php echo $count; ?></th>
                                                    <th colspan="5">Order time: <?php echo $result_date1['order_time']; ?></th>
                                                    <th colspan="2" class="toggle">Details</th>
                                                </tr>
                                            </thead>
                                            <!-- </table> -->
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td style="color:blue;">Delinquent</td>
                                                            </tr>
                                                        <?php

                                                        }
                                                        ?>
                                                        <td colspan="6" style="background-color:#2a2b2c;text-align:center;color:white;">Total orders: <?php echo number_format($total1, 0, ',', '.') . "" . "đ"; ?></td>
                                                        <td colspan="3" class="confirm" style="background-color:#2a2b2c;">
                                                            <div>
                                                                <span class="ti-check" style="color:white; font-size:15px;"></span>
                                                                <a style="text-decoration:none;font-size:15px;" onclick="return confirm('You want to confirm the goods')" href="?orderID=<?php echo $orderID ?>&status=1">Received the goods</a>
                                                            </div>
                                    ...
                                    ?>
                                            <table id="daGiao" class="daGiao table_2">
                                                <thead>
                                                    <tr>
                                                        <th>Order: <?php echo $count; ?></th>
                                                        <th colspan="3">Order time: <?php echo $result_date2['order_time']; ?></th>
                                                        <th colspan="2">Recieve time: <?php echo $result_date2['recieve_time']; ?></th>
                                                        <th colspan="2" class="toggle">Details</th>
                                                    </tr>
                                                </thead>
                                                <!-- </table> -->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td style="color:blue;cursor:pointer">Received the goods</td>

                                                                </tr>
                                                            <?php
                                                            }
                                                            ?>
                                                            <td colspan="7" style="background-color:#2a2b2c;text-align:center;color:white;">Total orders: <?php echo number_format($total2, 0, ',', '.') . "" . "đ"; ?></td>
                                                            ...
                                                            <div style="display: flex;align-items: center ; justify-content: center;">
                                                                ...
                                                                <a style="text-decoration:none;font-size:15px;" onclick="return confirm('You want to return the goods?')" href="?orderID=<?php echo $orderID ?>&status=2" >Returns</a>
                                                            </div>
                                                            </td>
                                                    <?php
                                                        }
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                    <tr>
                                                                        ...
                                                                        <td style="color:red;cursor:pointer">Wait for the return confirmation</td>

                                                                    </tr>
                                                                <?php
                                                                }
                                                                ?>
                                                                <td colspan="9" style="background-color:#2a2b2c;text-align:center;color:white;">Total orders: <?php echo number_format($total2, 0, ',', '.') . "" . "đ"; ?></td>
                                            ...
                                            ?>
                                                    <table id="daHuy" class="daHuy table_4">
                                                        <thead>
                                                            <tr>
                                                                <th>Order: <?php echo $count; ?></th>
                                                                <th colspan="4">Order time: <?php echo $result_date2['order_time']; ?></th>
                                                                <th colspan="3" class="toggle">Details</th>
                                                            </tr>
                                                        </thead>
                                                        <!-- </table> -->
                                                            ...
                                                            <tbody>
                                                                ...
                                                                ?>
                                                                        <tr>
                                                                            ...
                                                                            ?>
                                                                                <td style="color:red;cursor:pointer">Canceled </td>
                                                                            <?php
                                                                            } else {
                                                                            ?>
