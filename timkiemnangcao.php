						...
						<div class="col l-3">
							<form action="" method="GET">
								<div id=""  class="tim-kiem-nang-cao">
									...
									<!--  -->
									<div class="dmuc">
										<h4 class="h4">According to the list</h4>
										<ul class="danhmuc">
											<?php
									...
									<div style="width: 100%; text-align: center;">
										<input class="tim-kiem-nang-cao-input" type="submit" name="submit" value="Find" />
									</div>
								</div>
							 </form> 
						</div>
								...
								<form action="" method="GET">
									<div class="sort_price" style="display: flex;">										
										<select class="select-input" name="select" onchange="location = this.value;">																			
											<option>Choose by price</option>											
												<option value="timkiemnangcao.php?select=low-high" <?php if(isset($_GET['select']) && $_GET['select'] == 'low-high'){echo "selected";} ?>>Price from low to high</option>																		
												<option value="timkiemnangcao.php?select=high-low" <?php if(isset($_GET['select']) && $_GET['select'] == 'high-low'){echo "selected";} ?>>Price from high to low</option>
										</select>
									</div>
								</form>
							</div>
