                    ...
                    <div class="grid wide">
                        <div class="row">
                            <div class="col l-8" style="margin-top: 40px;">
                                <div class="col l-12">
                                    <div class="checkout-process-bar block-border">
                                        <ul>
                                            ...
                                            <li><span>Complete the application</span></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col l-12" style="margin: 20px 0;">
                                    <h3 style="padding: 10px;font-family: var(--font-family-sans-serif);">Delivery address</h3>
                                    <div style="border: 1px solid #e7e8e9;border-radius: 32px 0px 0px;">
                                        <?php
                            ...
                            <div class="cart-voucher">
								...
								?>
                                    ...
                                    <p class="btn"><a href="?orderid=order" id="btn_order" onclick="return alert('You have successfully ordered')">Order confirmation</a></p>
									</div>
								<?php
								} else {
								}
