                    ...
                    <div class="row">
                        <div class="col l-6">
                            ...
                            <div class="app_contact">
                                <div class="ti-location-pin">Lane 20 Ho Tung Mau, Mai Dich Ward, Cau Giay District, Hanoi</div>
                                <div class="ti-headphone-alt"> 0386396050</div>
                                <div class="ti-envelope"> 20070736@vnu.edu.vn</div>
                            </div>
                            <h1>Contact form</h1>
                            <div class="contact-form">
                                ...
                                <div class="contact-phone">
                                    <input type="text" id="phone" placeholder="Phonenumber">
                                </div>
