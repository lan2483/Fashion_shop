            ...
            <ul>
                ...
                <li class="header__search">
                    <form action="timkiemnangcao.php" method="GET">
                        ...
                        ?>
                        <input type="text" name="search" class="header__search-input" placeholder="Search product...">
                ...
                <li  class="nav-list">
                    <div class="nav-account">
                        ...
                        <ul class="nav-user_menu">
                            ...
                            <li class="nav-user_menu-item">
                                <a style="color: #ffffff;  font-size: 14px; font-weight: 600; text-decoration: none; font-family: var(--font-family-monospace);
                                " href="doimatkhau.php">Change Password</a>
                            </li>
                            <li class="nav-user_menu-item">
                                <a style="color: #ffffff;  font-size: 14px; font-weight: 600; text-decoration: none; font-family: var(--font-family-monospace);
                                " href="giohang.php">Cart</a>
                            </li>
                            <li class="nav-user_menu-item">
                                <a style="color: #ffffff;  font-size: 14px; font-weight: 600; text-decoration: none; font-family: var(--font-family-monospace);
                                " href="donhang.php">Order management</a>
                            </li>
                            <li class="nav-user_menu-item">
